...
if("TRUE" STREQUAL "TRUE")
  set(cv_camera_SOURCE_PREFIX /home/stereo/newspin_ws/src/cv_camera)
  set(cv_camera_DEVEL_PREFIX /home/stereo/newspin_ws/devel/.private/cv_camera)
  ...
  set(cv_camera_INSTALL_PREFIX /home/stereo/newspin_ws/install)
...
if(NOT "/home/stereo/newspin_ws/src/cv_camera/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  set(cv_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/stereo/newspin_ws/src/cv_camera/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/stereo/newspin_ws/src/cv_camera/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/stereo/newspin_ws/devel/.private/cv_camera/lib;/home/stereo/newspin_ws/devel/lib;/home/stereo/spinnaker_ws/devel/lib;/home/stereo/stereo_ws/devel/lib;/opt/ros/kinetic/lib)
