...
if("TRUE" STREQUAL "TRUE")
  set(image_publisher_SOURCE_PREFIX /home/stereo/newspin_ws/src/image_pipeline/image_publisher)
  set(image_publisher_DEVEL_PREFIX /home/stereo/newspin_ws/devel/.private/image_publisher)
  ...
  set(image_publisher_INSTALL_PREFIX /home/stereo/newspin_ws/install)
...
if(NOT "/home/stereo/newspin_ws/devel/.private/image_publisher/include " STREQUAL " ")
  set(image_publisher_INCLUDE_DIRS "")
  set(_include_dirs "/home/stereo/newspin_ws/devel/.private/image_publisher/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_publisher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/stereo/newspin_ws/src/image_pipeline/image_publisher/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/stereo/newspin_ws/devel/.private/image_publisher/lib;/home/stereo/newspin_ws/devel/lib;/home/stereo/spinnaker_ws/devel/lib;/home/stereo/stereo_ws/devel/lib;/opt/ros/kinetic/lib)
