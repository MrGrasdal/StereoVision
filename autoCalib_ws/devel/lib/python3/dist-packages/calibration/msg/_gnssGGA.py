...
"""autogenerated by genpy from calibration/gnssGGA.msg. Do not edit."""
import codecs
import sys
...
string modeStatus"""
  ...
  _slot_types = ['std_msgs/Header','time','float64','string','float64','string','float64','calibration/gnssGGA_status']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.status is None:
        self.status = calibration.msg.gnssGGA_status()
    else:
      self.header = std_msgs.msg.Header()
      self.sat_time = genpy.Time()
      self.latitude = 0.
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.status.modeStatus = str[start:end].decode('utf-8', 'rosmsg')
      else:
