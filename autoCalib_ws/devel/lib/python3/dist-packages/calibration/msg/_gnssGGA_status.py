...
"""autogenerated by genpy from calibration/gnssGGA_status.msg. Do not edit."""
import codecs
import sys
...
class gnssGGA_status(genpy.Message):
  ...
  _type = "calibration/gnssGGA_status"
...
string modeStatus"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.modeStatus = str[start:end].decode('utf-8', 'rosmsg')
      else:
